...
.drag-column .sticky-columns {
    display: block;
    background-color: rgba(149, 237, 100, 0.25);
    box-shadow: 0px 0px 0px 2px rgb(149, 237, 100);
}

.drag-column .sticky-columns:hover {
    display: block;
    background-color: rgba(100, 149, 237, 0.25);
    box-shadow: 0px 0px 0px 2px rgb(100, 149, 237);
}
